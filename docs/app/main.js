...
var message = ['広島コンピュータ専門学校 学生作品展2018のテーマ「 #ffffff 」。', '2018年の作品展はデザインコースとゲームコースの共同で開催いたします。', '「＃」はハッシュタグを連想して、発信していく思いを。', '"FFFFFF"はホワイトのカラーコードから、', 'キャンパスに自分たちの色を付けていこうという思いを込めて名付けました。', 'キャッチコピー「fから創り出せ。僕らの色彩。」はテーマの通り', '白いキャンパスに新たなアイデアを生み出そうと、"創り出せ"。', '様々な作品があることを、"色彩"に見立てています。'];

var Concept = function Concept() {
  return _react2.default.createElement(
    'section',
    { className: 'p-concept', id: 'concept' },
    _react2.default.createElement(Intro, null),
    _react2.default.createElement(IntervalRight, null),
    _react2.default.createElement(Theme, null),
    _react2.default.createElement(IntervalLeft, null),
    _react2.default.createElement(Details, null),
    _react2.default.createElement(ToTop, null)
  );
};
...
var Intro = function (_React$Component) {
  ...
  function Intro() {
    ...
    _this.state = {
      message: [message[0], message[1], message[2], message[3], message[4], message[5], message[6], message[7], message]
    };
    return _this;
  }
  ...
  _createClass(Intro, [{
    key: 'conceptText',
    value: function conceptText(i) {
      return _react2.default.createElement(
        'p',
        { className: 'p-concept__text  p-concept__text--display' },
        this.state.message[i]
      );
    }
  }, {
    key: 'conceptTextMobile',
    value: function conceptTextMobile(i) {
      return _react2.default.createElement(
        'p',
        { className: 'p-concept__text p-concept__text--mobile' },
        this.state.message[i]
      );
    }
  }, {
    ...
    value: function render() {
      return _react2.default.createElement(
        'div',
        { className: 'p-concept__container p-concept__container--left' },
        _react2.default.createElement(
          'div',
          { className: 'p-concept__textblock p-concept__textblock--left' },
          _react2.default.createElement('h2', { className: 'p-concept__title', alt: 'f\u304B\u3089\u5275\u308A\u51FA\u305B\u3002\u50D5\u3089\u306E\u8272\u5F69\u3002' }),
          _react2.default.createElement(
            'div',
            { className: 'p-concept__textarea' },
            this.conceptText(0),
            this.conceptText(1),
            this.conceptText(2),
            this.conceptText(3),
        ...
        _react2.default.createElement('div', { className: 'p-concept__logo p-concept__logo--right' })
      );
    }
  }]);
...
var Theme = function (_React$Component2) {
  _inherits(Theme, _React$Component2);

  function Theme() {
    _classCallCheck(this, Theme);

    var _this2 = _possibleConstructorReturn(this, (Theme.__proto__ || Object.getPrototypeOf(Theme)).call(this));
  ...
  _createClass(Theme, [{
    ...
    value: function conceptText(i) {
      return _react2.default.createElement(
        'p',
        { className: 'p-concept__theme-text' },
        this.state.message[i]
      );
    }
  }, {
    ...
    value: function render() {
      return _react2.default.createElement(
        'div',
        { className: 'p-concept__container' },
        _react2.default.createElement(
          'div',
          { className: 'p-concept__box' },
          _react2.default.createElement(
            'h2',
            { className: 'p-concept__theme' },
            '#ffffff'
          ),
          this.conceptText(0)
        ),
        _react2.default.createElement(LinkBox, null)
      );
    }
  }]);
...
var LinkBox = function (_React$Component3) {
  _inherits(LinkBox, _React$Component3);

  function LinkBox() {
    _classCallCheck(this, LinkBox);

    var _this3 = _possibleConstructorReturn(this, (LinkBox.__proto__ || Object.getPrototypeOf(LinkBox)).call(this));

    _this3.state = {
      titles: ['#FACT', '#FANTASY', '#FUTURE', '#FASHION', '#FACE', '#FLOWER'],
      links: ['/fact', '/fantasy', '/future', '/fashion', '/face', '/flower'],
      descriptions: ['事実・証拠という意味より、実際に"モノ"を作り展示いたします。', '想像、空想という意味から、ファンタジーな作品やゲームコースの作品を展示いたします。', '未来・将来という意味より、この先更に普及していくであろうWebについて焦点を当てています。', 'ファッション・流行という意味より、服のデザインなどのを展示いたします。', '顔・表情という意味より、人だけでなく様々な物事の表情についての作品を展示いたします。', '花という意味の通り、花を用いた作品を展示いたします。']
    };
    return _this3;
  }
  ...
  _createClass(LinkBox, [{
    key: 'linkBlock',
    value: function linkBlock(i) {
      return _react2.default.createElement(
        _reactRouterDom.Link,
        { to: this.state.links[i], className: 'p-linkbox__block' },
        _react2.default.createElement(
          'div',
          { className: 'p-linkbox__bg' },
          _react2.default.createElement('div', { className: 'p-linkbox__border' }),
          _react2.default.createElement(
            'p',
            { className: 'p-linkbox__description' },
            this.state.descriptions[i]
          ),
          _react2.default.createElement(
            'p',
            { className: 'p-linkbox__text' },
            this.state.titles[i]
          )
        )
      );
...
var Details = function (_React$Component4) {
  _inherits(Details, _React$Component4);

  function Details() {
    _classCallCheck(this, Details);

    var _this4 = _possibleConstructorReturn(this, (Details.__proto__ || Object.getPrototypeOf(Details)).call(this));

    _this4.state = {
      details: ['ゲーム・デザインコース', '学生作品展2018', '入場無料', '1.26(金)-28(日)', '広島コンピュータ専門学校', '広島県広島市西区横川新町7−12', '10:00-16:00', '(最終日は14:00まで)']
    };
    return _this4;
  }
  ...
  _createClass(Details, [{
    ...
    value: function render() {
      return _react2.default.createElement(
        'div',
        { className: 'p-concept__container p-concept__container--right' },
        _react2.default.createElement(
          'div',
          { className: 'p-concept__textblock p-concept__textblock--right' },
          _react2.default.createElement(
            'div',
            { className: 'p-detail' },
            _react2.default.createElement(
              'p',
              { className: 'p-detail__course' },
              this.state.details[0]
            ),
            _react2.default.createElement(
              'p',
              { className: 'p-detail__title' },
              this.state.details[1]
            ),
            _react2.default.createElement(
              'p',
              { className: 'p-detail__free' },
              this.state.details[2]
            ),
            _react2.default.createElement(
              'p',
              { className: 'p-detail__date' },
              this.state.details[3]
            ),
            _react2.default.createElement(
              'p',
              { className: 'p-detail__destination' },
              this.state.details[4]
            ),
            _react2.default.createElement(
              'p',
              { className: 'p-detail__add' },
              this.state.details[5]
            ),
            _react2.default.createElement(
              _reactRouterDom.Link,
              { to: '/access', className: 'p-detail__access' },
              '\u30A2\u30AF\u30BB\u30B9\u65B9\u6CD5\u306F\u3053\u3061\u3089'
            ),
            _react2.default.createElement(
              'p',
              { className: 'p-detail__time' },
              this.state.details[6]
            ),
            _react2.default.createElement(
              'p',
              { className: 'p-detail__lasttime' },
              this.state.details[7]
            )
          )
        ),
        _react2.default.createElement('div', { className: 'p-concept__logo p-concept__logo--left' })
      );
    }
  }]);
...
var IntervalLeft = function (_React$Component5) {
  _inherits(IntervalLeft, _React$Component5);

  function IntervalLeft() {
    _classCallCheck(this, IntervalLeft);

    return _possibleConstructorReturn(this, (IntervalLeft.__proto__ || Object.getPrototypeOf(IntervalLeft)).apply(this, arguments));
  }

  _createClass(IntervalLeft, [{
    key: 'render',
    value: function render() {
      return _react2.default.createElement(
        'div',
        { className: 'p-interval' },
        _react2.default.createElement('div', { className: 'p-interval__block p-interval__block--mask' }),
        _react2.default.createElement(
          'div',
          { className: 'p-interval__block p-interval__block--logo' },
          _react2.default.createElement('img', { src: 'assets/img/item4.svg', alt: 'logo', className: 'p-interval__logo p-interval__logo--left' })
        )
      );
    }
  }]);
...
var IntervalRight = function (_React$Component6) {
  _inherits(IntervalRight, _React$Component6);

  function IntervalRight() {
    _classCallCheck(this, IntervalRight);

    return _possibleConstructorReturn(this, (IntervalRight.__proto__ || Object.getPrototypeOf(IntervalRight)).apply(this, arguments));
  }

  _createClass(IntervalRight, [{
    key: 'render',
    value: function render() {
      return _react2.default.createElement(
        'div',
...
var ToTop = function (_React$Component7) {
  _inherits(ToTop, _React$Component7);

  function ToTop() {
    _classCallCheck(this, ToTop);

    var _this7 = _possibleConstructorReturn(this, (ToTop.__proto__ || Object.getPrototypeOf(ToTop)).call(this));
  ...
  _createClass(ToTop, [{
    ...
    value: function render() {
      return _react2.default.createElement(
        _reactRouterDom.Link,
        { to: '/', className: 'c-totop' },
        _react2.default.createElement('div', { className: 'c-totop__box' })
      );
    }
  }]);
...
var Access = function (_React$Component) {
  ...
  _createClass(Access, [{
    ...
    value: function render() {
      return _react2.default.createElement(
        'div',
        { className: 'p-access', id: 'access' },
        _react2.default.createElement(
          'div',
          { className: 'p-access__hero' },
          _react2.default.createElement(
            'h1',
            { className: 'p-access__title' },
            'Access'
          )
        ),
        _react2.default.createElement(
          'div',
          { className: 'p-access__container' },
          _react2.default.createElement(
            'div',
            { className: 'p-access__textbox' },
            _react2.default.createElement(
              'div',
              { className: 'p-access__textblock' },
              _react2.default.createElement(
                'p',
                { className: 'p-access__destination' },
                '\u5E83\u5CF6\u30B3\u30F3\u30D4\u30E5\u30FC\u30BF\u5C02\u9580\u5B66\u6821'
              ),
              _react2.default.createElement(
                'p',
              ...
              _react2.default.createElement(
                'p',
                { className: 'p-access__add' },
                '\u5E83\u5CF6\u770C\u5E83\u5CF6\u5E02\u897F\u533A\u6A2A\u5DDD\u65B0\u753A7\u221212'
              ),
              _react2.default.createElement(
                'p',
                { className: 'p-access__tell' },
                'TEL 082-291-5050'
              ),
              _react2.default.createElement(
                'a',
                { href: 'https://goo.gl/maps/WTaypixUpWv', className: 'p-access__link', target: 'new' },
                'Goole Map\u306F\u3053\u3061\u3089'
              )
            ),
            _react2.default.createElement(
              ...
              _react2.default.createElement(
                'p',
                { className: 'p-access__text' },
                '\u304A\u8D8A\u3057\u306E\u969B\u306F\u516C\u5171\u4EA4\u901A\u6A5F\u95A2\u3067\u304A\u9858\u3044\u3057\u307E\u3059\u3002JR\u306E\u5834\u5408\u306F\u6A2A\u5DDD\u99C5\u304B\u3089\u5F92\u6B693\u5206\u3001\u5E02\u5185\u96FB\u8ECA\u306E\u5834\u5408\u306F\u6A2A\u5DDD\u4E00\u4E01\u76EE\u96FB\u505C\u304B\u3089\u5F92\u6B692\u5206\u3067\u3059\u3002\u5165\u5834\u7121\u6599\u3067\u3059\u306E\u3067\u6C17\u8EFD\u306B\u8DB3\u3092\u304A\u904B\u3073\u304F\u3060\u3055\u3044\u3002'
              )
            )
          ),
          _react2.default.createElement('img', { src: './assets/img/map_bg.png', alt: '\u5730\u56F3', className: 'p-access__mapimage', onClick: this.toggleClass }),
          _react2.default.createElement(
            'p',
            { className: 'p-access__careful' },
            '\u203B\u5B66\u751F\u4F5C\u54C1\u5C55\u306F\u4EA4\u901A\u8CBB\u88DC\u52A9\u306E\u5BFE\u8C61\u5916\u3067\u3059\u3002\u3042\u3089\u304B\u3058\u3081\u3054\u4E86\u627F\u304F\u3060\u3055\u3044\u3002'
          )
        ),
        _react2.default.createElement(
          'div',
          { className: this.state.isActive ? 'c-modal is-active' : 'c-modal', onClick: this.toggleClass },
          _react2.default.createElement('img', { src: './assets/img/map_bg.png', alt: '\u5730\u56F3', className: 'c-modal__image' })
        )
      );
    }
  }]);
...
var _reactRouterScrollMemory = __webpack_require__(77);

var _reactRouterScrollMemory2 = _interopRequireDefault(_reactRouterScrollMemory);
  ...
  _createClass(App, [{
    ...
    value: function render() {
      return (
        ...
        _react2.default.createElement(
          'div',
          { className: this.state.isActive ? 'l-wrap__box is-active' : 'l-wrap__box' },
          _react2.default.createElement(_menu2.default, { toggleClassFnc: this.toggleClass, propsIsActive: this.state.isActive }),
          _react2.default.createElement(_sidebar2.default, { toggleClassFnc: this.toggleClass }),
...
(0, _reactDom.render)(_react2.default.createElement(
  ...
  _react2.default.createElement(
    'div',
    { className: 'l-wrap', id: 'wrap' },
    _react2.default.createElement(_reactRouterScrollMemory2.default, null),
...
*/
var aa=__webpack_require__(0),m=__webpack_require__(23),A=__webpack_require__(7),B=__webpack_require__(5),ca=__webpack_require__(24),da=__webpack_require__(25),ea=__webpack_require__(26),ha=__webpack_require__(27),ia=__webpack_require__(28),C=__webpack_require__(11);
...
"use strict";
function _interopDefault(e){return e&&"object"==typeof e&&"default"in e?e.default:e}function _classCallCheck(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}function _possibleConstructorReturn(e,t){if(!e)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");return!t||"object"!=typeof t&&"function"!=typeof t?e:t}function _inherits(e,t){if("function"!=typeof t&&null!==t)throw new TypeError("Super expression must either be null or a function, not "+typeof t);e.prototype=Object.create(t&&t.prototype,{constructor:{value:e,enumerable:!1,writable:!0,configurable:!0}}),t&&(Object.setPrototypeOf?Object.setPrototypeOf(e,t):e.__proto__=t)}var React=_interopDefault(__webpack_require__(0)),reactRouterDom=__webpack_require__(6),getPage=function(){var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:[],t=arguments[1],o=e.map(function(e){return e.pathname}).indexOf(t);return o>-1?e[o]:void 0},getIndexPage=function(){var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:[],t=arguments[1];return e.map(function(e){return e.pathname}).indexOf(t)},saveUrl=function(e){var t=arguments.length>1&&void 0!==arguments[1]?arguments[1]:"",o=arguments.length>2&&void 0!==arguments[2]?arguments[2]:0,n=Array.isArray(e)?e:[],r=getIndexPage(n,t);return r>-1?(n[r].scroll=o,n):(n.push({pathname:t,scroll:o}),n)},getScrollPage=function(){var e=0;return document.documentElement&&null!==document.documentElement&&(e=document.documentElement.scrollTop),window.pageYOffset||e},scrollTo=function(){var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:0;return window.requestAnimationFrame(function(){window.scrollTo(0,e)})},isBrowser=function(){return"undefined"!=typeof window},ScrollMemory=function(e){function t(o){_classCallCheck(this,t);var n=_possibleConstructorReturn(this,e.call(this,o));return n.detectPop=n.detectPop.bind(n),n.url=[],n.requestID=0,n}return _inherits(t,e),t.prototype.componentDidMount=function(){isBrowser()&&window.addEventListener("popstate",this.detectPop)},t.prototype.componentWillReceiveProps=function(e){if(isBrowser()){var t=this.props.location,o=e.location!==t,n=getScrollPage();o&&(this.requestID=scrollTo(0),this.url=saveUrl(this.url,t.pathname,n))}},t.prototype.componentWillUnmount=function(){isBrowser()&&window.removeEventListener("popstate",this.detectPop)},t.prototype.detectPop=function(){if(isBrowser()){var e=window.location.pathname,t=getPage(this.url,e);this.requestID>0&&(window.cancelAnimationFrame(this.requestID),this.requestID=0),t&&scrollTo(t.scroll)}},t.prototype.render=function(){return null},t}(React.Component),ScrollMemory$1=reactRouterDom.withRouter(ScrollMemory);module.exports=ScrollMemory$1;
...
var Sidebar = function (_React$Component) {
  ...
  _createClass(Sidebar, [{
    key: 'renderTitleblock',
    value: function renderTitleblock() {
      return _react2.default.createElement(
        'div',
        { className: 'l-sidebar__titleblock' },
        _react2.default.createElement(
          _reactRouterDom.Link,
          { to: '/', className: 'l-sidebar__link', onClick: this.props.toggleClassFnc },
          _react2.default.createElement('img', { src: 'assets/logo/top_logo.svg', alt: '\u5E83\u5CF6\u30B3\u30F3\u30D4\u30E5\u30FC\u30BF\u5C02\u9580\u5B66\u6821 \u5B66\u751F\u4F5C\u54C1\u5C552018', className: 'l-sidebar__brand' })
        )
      );
    }
  }, {
    key: 'renderListblock',
    value: function renderListblock() {
      return _react2.default.createElement(
        'div',
        { className: 'l-sidebar__listblock' },
        _react2.default.createElement(
          'ul',
          { className: 'l-sidebar__listbox l-sidebar__listbox--main p-nav' },
          this.renderLink(0),
          this.renderLink(1),
          this.renderLink(2),
          this.renderLink(3),
        ...
        _react2.default.createElement(
          'ul',
          { className: 'l-sidebar__listbox l-sidebar__listbox--sub p-nav' },
          this.renderAccessLink(),
          _react2.default.createElement(
            'li',
            { className: 'l-sidebar__list p-nav__list' },
            _react2.default.createElement(
              'a',
              { href: 'https://twitter.com/hirocom_sakuhin', className: 'l-sidebar__item p-nav__item', onClick: this.props.toggleClassFnc, target: 'new' },
              'TWITTER'
            )
          )
        )
    ...
    key: 'renderAccessLink',
    value: function renderAccessLink() {
      return _react2.default.createElement(
        'li',
        { className: 'l-sidebar__list p-nav__list' },
        _react2.default.createElement(
          _reactRouterDom.Link,
          { to: this.state.access[1], className: 'l-sidebar__item p-nav__item', onClick: this.props.toggleClassFnc },
          this.state.access[0]
        )
      );
    }
    ...
    key: 'renderLink',
    value: function renderLink(i) {
      return _react2.default.createElement(
        'li',
        { className: 'l-sidebar__list p-nav__list' },
        _react2.default.createElement(
          _reactRouterDom.Link,
          { to: this.state.links[i], className: 'l-sidebar__item p-nav__item', onClick: this.props.toggleClassFnc },
          _react2.default.createElement(
            'span',
            { className: 'l-sidebar__span' },
            '#'
          ),
          this.state.titles[i]
        )
    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'div',
          { className: 'l-sidebar__container' },
...
var _top = __webpack_require__(81);

var _top2 = _interopRequireDefault(_top);

var _face = __webpack_require__(83);

var _face2 = _interopRequireDefault(_face);

var _fact = __webpack_require__(84);

var _fact2 = _interopRequireDefault(_fact);

var _fantasy = __webpack_require__(85);

var _fantasy2 = _interopRequireDefault(_fantasy);

var _fashion = __webpack_require__(86);

var _fashion2 = _interopRequireDefault(_fashion);

var _flower = __webpack_require__(87);

var _flower2 = _interopRequireDefault(_flower);

var _future = __webpack_require__(88);

var _future2 = _interopRequireDefault(_future);

var _concept = __webpack_require__(36);
...
var Content = function Content() {
  return _react2.default.createElement(
    ...
    _react2.default.createElement(
      ...
      null,
      _react2.default.createElement(_reactRouterDom.Route, { exact: true, path: '/', component: _top2.default }),
      _react2.default.createElement(_reactRouterDom.Route, { path: '/concept', component: _concept2.default }),
      _react2.default.createElement(_reactRouterDom.Route, { path: '/access', component: _access2.default }),
      _react2.default.createElement(_reactRouterDom.Route, { path: '/fact', component: _fact2.default }),
      _react2.default.createElement(_reactRouterDom.Route, { path: '/fantasy', component: _fantasy2.default }),
      _react2.default.createElement(_reactRouterDom.Route, { path: '/future', component: _future2.default }),
      _react2.default.createElement(_reactRouterDom.Route, { path: '/fashion', component: _fashion2.default }),
      _react2.default.createElement(_reactRouterDom.Route, { path: '/face', component: _face2.default }),
      _react2.default.createElement(_reactRouterDom.Route, { path: '/flower', component: _flower2.default })
    ),
  ...
  _createClass(Footer, [{
    ...
    value: function renderNav() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'li',
          { className: 'l-footer__list' },
          _react2.default.createElement(
            _reactRouterDom.Link,
            { to: '', className: 'l-footer__item' },
            'TOP'
          )
        ),
        this.renderLink(0),
    ...
    value: function renderLink(i) {
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          _reactRouterDom.Link,
          { to: this.state.links[i], className: 'l-footer__item' },
          _react2.default.createElement(
            'span',
            { className: 'l-footer__span' },
            '#'
          ),
          this.state.titles[i]
        )
    ...
    value: function renderAccessLink() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          _reactRouterDom.Link,
          { to: this.state.access[1], className: 'l-footer__item' },
          this.state.access[0]
        )
      );
    }
    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'p',
          { className: 'l-footer__legal' },
          'Copyright \xA9 Hiroshima Computer College. All Rights Reserved.'
        )
      );
    }
  }]);
...
var _body = __webpack_require__(82);
...
var Hero = function Hero() {
  return _react2.default.createElement(
    ...
    _react2.default.createElement('div', { className: 'p-top__text p-top__text--first' }),
    _react2.default.createElement('h2', { className: 'p-top__logo' }),
    _react2.default.createElement('div', { className: 'p-top__text p-top__text--last' })
  );
};
var Brand = function Brand() {
  return _react2.default.createElement('a', { href: 'http://www.hsc.ac.jp/', target: 'new', className: 'p-top__brand' });
};
...
var Face = function (_React$Component) {
  ...
  _createClass(Face, [{
    ...
    value: function renderHero() {
      return _react2.default.createElement(
        'div',
        { className: this.state.className.hero },
        _react2.default.createElement(
          'h1',
    ...
    value: function renderDescription() {
      return _react2.default.createElement(
        'div',
        { className: 'p-page__box p-page__box--description' },
        _react2.default.createElement('img', { src: this.state.imgSrc, alt: this.state.name, className: 'p-page__titleimg' }),
        _react2.default.createElement(
          'p',
          { className: 'p-page__descriptiontext' },
    ...
    value: function renderList() {
      ...
      return _react2.default.createElement(
        'div',
        { className: 'p-page__box p-page__box--list' },
        _react2.default.createElement(
          'h2',
          { className: 'p-page__listtitle' },
          this.state.listTitle
        ),
        _react2.default.createElement(
          'div',
          { className: 'p-page__list' },
          _react2.default.createElement(
            'p',
            { className: 'p-page__listitem' },
            this.state.exhibition.title
          ),
          _react2.default.createElement(
            'p',
            { className: 'p-page__listdetail' },
            this.state.exhibition.detail
          ),
          _react2.default.createElement(
            'p',
            { className: 'p-page__listitem' },
            this.state.listOther
          )
        )
      );
    }
    ...
    value: function renderContents() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'div',
          { className: 'p-page__container' },
          this.renderDescription()
        ),
        this.renderList(),
        _react2.default.createElement(
          'div',
          { className: 'p-page__overlay' },
          _react2.default.createElement('div', { className: 'p-page__bg' })
        )
      );
    }
  }, {
    ...
    value: function render() {
      return _react2.default.createElement(
        'div',
        { className: this.state.className.base },
        this.renderHero(),
        this.renderContents()
      );
    }
...
var Fact = function (_React$Component) {
  ...
  function Fact() {
    ...
    var _this = _possibleConstructorReturn(this, (Fact.__proto__ || Object.getPrototypeOf(Fact)).call(this));
...
var Fantasy = function (_React$Component) {
  _inherits(Fantasy, _React$Component);
  ...
  function Fantasy() {
    ...
    var _this = _possibleConstructorReturn(this, (Fantasy.__proto__ || Object.getPrototypeOf(Fantasy)).call(this));
...
var Fashion = function (_React$Component) {
  _inherits(Fashion, _React$Component);
  ...
  function Fashion() {
    ...
    var _this = _possibleConstructorReturn(this, (Fashion.__proto__ || Object.getPrototypeOf(Fashion)).call(this));
...
var exhibitionDetial = [{ text: '好きな色の花紙を使って、大きな花を作ります' }];

var Flower = function (_React$Component) {
  _inherits(Flower, _React$Component);
  ...
  function Flower() {
    ...
    var _this = _possibleConstructorReturn(this, (Flower.__proto__ || Object.getPrototypeOf(Flower)).call(this));
...
var Menu = function (_React$Component) {
  ...
  _createClass(Menu, [{
    ...
    value: function renderItem() {
      return _react2.default.createElement('span', { className: 'c-menu__item' });
    }
  }, {
    key: 'toggleText',
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        'div',
        { className: 'c-menu', onClick: function onClick(event) {
            _this2.props.toggleClassFnc();_this2.toggleText();
          } },
        this.renderItem(),
        this.renderItem(),
        this.renderItem(),
        _react2.default.createElement(
          'p',
          { className: this.props.propsIsActive ? 'c-menu__text c-menu__text--active' : 'c-menu__text' },
          this.props.propsIsActive ? 'CLOSE' : 'MENU'
        ),
        _react2.default.createElement('div', { className: 'c-menu__bg' })
      );
    }
  }]);
